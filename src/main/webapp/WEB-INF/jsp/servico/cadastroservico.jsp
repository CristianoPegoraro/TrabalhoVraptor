	...
	<form class="clienteform " action="/your.groupid/servico/cadastrar" method="post">
		...
		<div class="form-group">
			<div class="row">
				...
				<div class="form-group col-xs-12 col-sm-3 col-md-3 col-lg-3">
					<label class="col-md-12 control-label" for="servico.garantia">Garantia:</label>
					<div class="col-xs-12">
				...
				<div class="form-group col-xs-12 col-sm-6 col-md-6 col-lg-6">
					...
					<div class="col-xs-12">
						...
						rows="2" >${servico.descricao}</textarea>
				...
				<div class="form-group col-xs-12 col-sm-6 col-md-6 col-lg-6">
					...
					<div class="col-xs-12">
						...
						rows="2" >${servico.defeito}</textarea>
				</div>
</div>
				<div class="form-group col-xs-12 col-sm-6 col-md-6 col-lg-6">
					<label class="col-md-4 control-label" for="servico.observacao">Observação:</label>
					<div class="col-xs-12">
						<textarea name="servico.observacao" type="text" class="form-control"
						rows="3" >${servico.observacao}</textarea>
					</div>
				</div>
