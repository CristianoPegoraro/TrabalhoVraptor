...
<div class="col-xs-12 col-sm-10 col-md-10 col-lg-10 clienteform">
	<form class="clienteform " action="/servico/cadastrar" method="post">
		...
		<div class="form-group">
			<div class="row">
				...
				<div class="form-group col-xs-12 col-sm-6 col-md-6 col-lg-6">
					<label class="col-md-12 control-label" for="servico.status">Status:</label>
					<div class="col-xs-12">
					X${servico.status}X
